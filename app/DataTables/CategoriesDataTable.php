...
class CategoriesDataTable extends DataTable
{
     ...
     *
     * @param \App\Models\Suub_categorysDataTable $model
    ...
    protected function getColumns()
    {
        ...
        return [
            ...
            str_replace(' ', '_', trans("dashboard.Categor"))  => ['data'=>'portal_id','name'=>'portal_id'],
