...
class UsersDataTable extends DataTable
{
    ...
    protected function getColumns()
    {
        ...
        return [
            ...
            str_replace(' ', '_', trans("dashboard.Name")) => ['data'=>'name','name'=>'name'],
            str_replace(' ', '_', trans("dashboard.Email"))  => ['data'=>'email','name'=>'email'],
